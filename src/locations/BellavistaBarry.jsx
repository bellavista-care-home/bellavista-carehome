...
const BellavistaBarry = () => {
  ...
  return (
    <div className="location-page theme-barry home">
      ...
      <UnifiedHero
        title={homeData?.heroTitle || "Nursing Home in Barry"}
        ...
        badges={[
          {
            icon: 'fas fa-bed',
            label: homeData?.statsBedrooms || '39 Bedrooms'
          },
          {
            icon: 'fas fa-map-marker-alt',
            label: 'Barry Seaside',
            href: 'https://www.google.com/maps/search/?api=1&query=Bellavista+Nursing+Home+Barry'
          },
          {
            icon: 'fas fa-star',
            label: 'Quality Care',
