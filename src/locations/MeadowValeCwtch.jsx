...
const MeadowValeCwtch = () => {
  ...
  return (
    <div className="location-page theme-meadow-vale home">
      ...
      <UnifiedHero
        title="Meadow Vale Cwtch"
        subtitle="Specialist young onset dementia care — purpose-built by the Bellavista Group"
        description="Meadow Vale Cwtch is a purpose-built specialist nursing home focused on exceptional young onset dementia care in a safe and supportive setting."
        imageSrc="/home-images/meadow-vale-cwtch.jpg"
        imageAlt="Meadow Vale Cwtch"
        galleryImages={bannerImages}
        galleryAltPrefix="Bellavista highlight"
        badges={[
          {
            icon: 'fas fa-bed',
            label: homeData?.statsBedrooms || '9 Bedrooms'
          },
          {
            icon: 'fas fa-map-marker-alt',
            label: 'Vale of Glamorgan',
            href: 'https://www.google.com/maps/search/?api=1&query=Meadow+Vale+Cwtch+Barry'
          },
          {
            icon: 'fas fa-star',
            label: 'Quality Care',
        ...
        <div className="container">
          <div className={servicesGalleryImages.length > 0 ? "loc-grid" : ""}>
            ...
            <div className={servicesGalleryImages.length > 0 ? "loc-grid__content" : ""}>
              ...
              {homeData?.servicesContent ? (
                ...
                <>
                  <p className="loc-text">
                    {homeData?.servicesIntro || 'Meadow Vale Cwtch provides a range of specialist services, including:'}
                  </p>
              ...
              <Link to="/care/meadow-vale-cwtch" className="btn btn-primary" style={{ marginTop: '24px', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
        ...
        <div className="container">
          <div className="section-header centered">
            ...
            <div className="rating-badges">
              <a href="https://www.google.com/search?q=Meadow+Vale+Cwtch+Barry#lrd=0x486e09597f7e580b:0x22f8a99287879acd,1,,," target="_blank" rel="noopener noreferrer" className="rating-badge google-badge">
